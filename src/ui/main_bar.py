...
class MainBar(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        # Filtro de Status de Tags
        self.tag_filter_combo = QComboBox()
        self.tag_filter_combo.setEditable(False)
        self.tag_filter_combo.addItem("🌐 Todas", "all")
        self.tag_filter_combo.addItem("🏷️ Com Tags", "tagged")
        self.tag_filter_combo.addItem("⚪ Sem Tags", "untagged")
        self.tag_filter_combo.setToolTip("Filtrar arquivos por status de tags:\n• Todas: exibe tudo\n• Com Tags: esconde fotos sem tags\n• Sem Tags: exibe apenas fotos pendentes de catalogação")
        tag_label = QLabel("Tags:")
        tag_label.setFixedWidth(35)
        self.unified_layout.addWidget(tag_label)
        self.unified_layout.addWidget(self.tag_filter_combo)
        self.unified_layout.addSpacing(5)
        ...
        self.action_explorer.setChecked(True)
